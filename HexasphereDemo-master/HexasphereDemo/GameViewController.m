...
- (void)viewDidLoad
{
    ...
    Hexasphere *earth = [Hexasphere hexasphereWithRadius:GLOBE_RADIUS numDivisions:40 andHexSize:0.9];
    earth.name = @"earth";
	...
	SCNSphere *sphere = [SCNSphere sphereWithRadius:3.97];
	sphere.firstMaterial.diffuse.contents = [UIColor blueColor];
	
	SCNNode *inner = [SCNNode nodeWithGeometry:sphere];
	[scene.rootNode addChildNode:inner];
